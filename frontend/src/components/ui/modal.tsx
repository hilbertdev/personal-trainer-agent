        ...
        {(title || description) && (
          <div className="flex items-start justify-between gap-4 border-b border-zinc-200 px-4 py-4 dark:border-white/10 sm:px-6 sm:py-5">
            ...
            <button
              ...
              aria-label="Close"
              onClick={onClose}
              className="rounded-full p-2 text-zinc-500 transition-colors hover:bg-zinc-950/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lime-300 dark:text-zinc-400 dark:hover:bg-white/10"
            >
